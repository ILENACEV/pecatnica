...
Podeli N summaries vo grupi po 2 (G=2). Za sekoja grupa glasaј 8 pati
...
uslovен na niv -> finalen RTV. Ne frlaj ja istorijata, destiliraj ja.

## 4. Verifier gate (apsolutna porta)
Niedna promena ne propagira bez sandbox-egzekucija:
`pass = izlez e prazен AND FAILED/ERROR ne e vo output`.
